...
namespace Stockfish::Eval::NNUE::Features {
  ...
  class HalfKAv2 {
    ...
    // PIECE_TYPE_BITS=7: PIECE_TYPE_NB=128, PIECE_NB=256.
    // W_KING=127, B_PAWN=129, B_KING=255. Table expanded accordingly.
    static constexpr uint32_t PieceSquareIndex[COLOR_NB][PIECE_NB] = {
      // convention: W - us, B - them
      // viewed from other side, W and B are reversed
      {
        // White pieces, Piece indices 0-127 (W_PAWN=1..W_QUEEN=5, W_KING=127)
        ...
        // Black pieces, Piece indices 128-255 (B_PAWN=129..B_QUEEN=133, B_KING=255)
      ...
      {
        // Black pieces from BLACK's POV (them=W_*, us=B_*), Piece indices 0-127
        PS_NONE, PS_B_PAWN, PS_B_KNIGHT, PS_B_BISHOP, PS_B_ROOK, PS_B_QUEEN, PS_NONE, PS_NONE,
        PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE,
        PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE,
        PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE,
        ...
        PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE,
        PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_KING,
        // White pieces from BLACK's POV, Piece indices 128-255
        PS_NONE, PS_W_PAWN, PS_W_KNIGHT, PS_W_BISHOP, PS_W_ROOK, PS_W_QUEEN, PS_NONE, PS_NONE,
        PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE,
        PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE,
        PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE, PS_NONE,
